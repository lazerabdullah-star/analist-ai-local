...
export default function Login({ onSuccess }) {
  ...
  const girisYap = async (e) => {
    ...
    const authHeader = 'Basic ' + btoa(`${kullaniciAdi}:${sifre}`)
  ...
  return (
    <div style={{
      ...
      <form onSubmit={girisYap} style={{
        ...
        <h2 style={{ color: '#F1F5F9', margin: 0, fontSize: 20 }}>Analist AI Local</h2>
        <p style={{ color: '#94A3B8', margin: 0, fontSize: 13 }}>Devam etmek için giriş yapın</p>
